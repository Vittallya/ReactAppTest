...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest testapp.client -- --template=react  --no-rolldown --no-immediate`.
...
- Создание файла проекта (`testapp.client.esproj`).
